...
function stopAllAudios() {
	...
	var elementList = document.getElementsByTagName("audio");
	
	for (var i = 0; i < elementList.length; i++) {
		elementList.item(i).pause();
	}
...
function turnBoxOn(boxId) {
	//if (overlayOn = false) {}
	//overlayOn = true;
    document.getElementById(boxId).style.display = "block";
}

function turnBoxOff(boxId) {
	//if (overlayOn = false) {}
	//overlayOn = true;
